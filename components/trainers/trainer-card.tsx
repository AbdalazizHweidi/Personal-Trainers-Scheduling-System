...
type Props = { id: number; full_name: string; specialties: string[]; photo_url: string | null };

export function TrainerCard({ id, full_name, specialties, photo_url }: Props) {
  ...
  return (
    ...
    >
      {photo_url ? (
        <img src={photo_url} alt={full_name} className="h-14 w-14 rounded-full object-cover" />
      ) : (
